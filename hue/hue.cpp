...
int lampStatus(LampOwners owner){
    ...
    if(curl) {
        ...
        if (owner == dillon){
            curl_easy_setopt(curl, CURLOPT_URL, "192.168.1.8/api/29ocf3mMaJ1XAtbqeKM60A4dFen9tSc96u1JuQAi/lights/4");
        }
        else if (owner == sara){
            curl_easy_setopt(curl, CURLOPT_URL, "192.168.1.8/api/29ocf3mMaJ1XAtbqeKM60A4dFen9tSc96u1JuQAi/lights/3");
        }
...
void switchLamp(LampOwners owner, LampParameter parameter){
    ...
    if (curl) {
        ...
        if (owner == dillon){
            ...
            curl_easy_setopt(curl, CURLOPT_URL, "192.168.1.8/api/29ocf3mMaJ1XAtbqeKM60A4dFen9tSc96u1JuQAi/lights/4/state");
        }
        else if (owner == sara){
            std::cout << "Sara's lamp ";
            curl_easy_setopt(curl, CURLOPT_URL, "192.168.1.8/api/29ocf3mMaJ1XAtbqeKM60A4dFen9tSc96u1JuQAi/lights/3/state");
        }
        else if (owner == both){
            std::cout << "Both lamps ";
            curl_easy_setopt(curl, CURLOPT_URL, "192.168.1.8/api/29ocf3mMaJ1XAtbqeKM60A4dFen9tSc96u1JuQAi/groups/1/action");
        }
        else{
            return;
        }
